    ...
    public class AzDOOrganizationDbInitializer : DropCreateDatabaseAlways<AzDOOrganizationDbContext>
    {
        ...
        private List<Organization> GetOrganizations()
        {
            var orgs = new List<Organization>
            {
                ...
                new Organization { Id = 1, Name="accenture", UpdateFields = false, IncludeInFieldReports = false},
                new Organization { Id = 2, Name="accenturecio", UpdateFields = false, IncludeInFieldReports = false},
                new Organization { Id = 3, Name="accenturecio01", UpdateFields = false, IncludeInFieldReports = true},
                new Organization { Id = 4, Name="accenturecio02", UpdateFields = false, IncludeInFieldReports = false},
                new Organization { Id = 5, Name="accenturecio03", UpdateFields = false, IncludeInFieldReports = false},
                new Organization { Id = 6, Name="accenturecio04", UpdateFields = false, IncludeInFieldReports = false},
                new Organization { Id = 7, Name="accenturecio05", UpdateFields = false, IncludeInFieldReports = false},
                new Organization { Id = 8, Name="accenturecio06", UpdateFields = false, IncludeInFieldReports = false},
                new Organization { Id = 9, Name="accenturecio07", UpdateFields = false, IncludeInFieldReports = false},
                new Organization { Id = 10, Name="accenturecio08", UpdateFields = false, IncludeInFieldReports = false},
                new Organization { Id = 11, Name="accenturecio09", UpdateFields = false, IncludeInFieldReports = false},
                new Organization { Id = 12, Name="accenturecio10", UpdateFields = false, IncludeInFieldReports = false},
                new Organization { Id = 13, Name="accenturecio11", UpdateFields = false, IncludeInFieldReports = false},
                new Organization { Id = 14, Name="accentureciostg", UpdateFields = false, IncludeInFieldReports = false},
                new Organization { Id = 15, Name="accentureciodev", UpdateFields = false, IncludeInFieldReports = false},
            };
